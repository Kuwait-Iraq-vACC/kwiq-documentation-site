...
| --------- | --------	| ---------	| -------- | ------- |
| **Erbil TWR** | **Erbil Tower** | **128.800** | **ORER_TWR** | |
...
!!! phraseology
    ...
    **RER TWR**: ABC, Erbil Tower, cleared to operate in the circuit area not above altitude 6000ft, right hand circuits report on the downwind, surface winds 320 degrees 5 knots, cleared for take-off runway 18.  
...
!!! phraseology
    ...
    **RER TWR**: FYI, Erbil Tower, surface winds 320 degrees 5 knots, cleared for take-off runway 18.  
    **FYI**: Roger, cleared for take-off runway 18.  
    **AIRCRAFT ON THE CROSSWIND TURN**  
    **RER TWR**: FYI, report leaving the Erbil CTR, maintain at or below altitude 6000ft.  
...
!!! phraseology
    ...
    **RER TWR**: YYC, Erbil Tower, cleared to leave the Erbil CTR direct Kirkuk, maintain altitude 5500ft, squawk 7403, QNH 998 hectopascals.  
...
On initial contact, Erbil **TWR** will pass the instructions for joining the circuit, as well as any other pertinent information such as traffic information with the sector.

!!! phraseology
    **YYC**: Erbil Tower, YYC is requesting to enter the Erbil CTR from the south for circuits.     
    **RER TWR**: YYC, Erbil Tower, information A, cleared to enter the Erbil CTR, maintain at or below altitude 6000ft, report right downwind runway 18 with intentions, squawk 7403.  
    ...
    **RER TWR**: YYC, correct, QNH 998 hectopascals.    
...
## IFR Operations
IFR clearances are issued by Erbil **TWR**, ensuring appropriate routing.
...
!!! phraseology
    ...
    **RER TWR**: IAW123, Erbil Tower, cleared to Antalya, EMID1S departure, flight planned route, initial climb 6000ft, squawk 4301. 
...
!!! phraseology
    **IAW123**: Erbil Tower, IAW123, request clearance to Antalya, with information Alpha.  
    **RER TWR**: IAW123, Erbil Tower, cleared to Antalya, expect omni-directional departure, flight planned route, squawk 4301. 
...
!!! phraseology
    ...
    **RER TWR**: IAW123, Erbil Tower, report established on the ILS runway 18.  


## Standard Taxi Routes
All departing aircraft shall be assigned the most appropriate taxiway, onto taxiway A. Erbil **TWR** must exercise extreme caution on taxiway A, as conflicts can easily occur between arriving and departing traffic. Taxiway B is restricted to military traffic only.
...
The Standard Assignable level from Erbil **TWR** to Baghdad **TMA** is:
...
!!! phraseology
    ...
    **RER TWR**: IAW23, after departure climb to altitude 6000ft, fly runway heading, surface winds variable at 3 knots, runway 18 cleared for take-off.
