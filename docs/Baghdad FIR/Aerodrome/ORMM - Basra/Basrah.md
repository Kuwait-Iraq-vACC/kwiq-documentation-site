...
| --------- | --------	| ---------	| -------- | ------- |
| **Basra TWR** | **Basra Tower** | **118.700** | **ORMM_TWR** | |
...
!!! phraseology
    ...
    **BSR TWR**: ABC, Basra Tower, cleared to operate in the circuit area not above altitude 3000ft, left hand circuits report on the downwind, surface winds 320 degrees 5 knots, cleared for take-off runway 32.  
...
!!! phraseology
    ...
    **BSR TWR**: FYI, Basra Tower, surface winds 320 degrees 5 knots, cleared for take-off runway 32.  
    **FYI**: Roger, cleared for take-off runway 18.  
    **AIRCRAFT ON THE CROSSWIND TURN**  
    **BSR TWR**: FYI, report leaving the Basra CTR, maintain at or below altitude 3000ft.  
...
!!! phraseology
    ...
    **BSR TWR**: YYC, Basra Tower, cleared to leave the Basra CTR direct Al-Najaf, maintain altitude 5500ft, squawk 7403, QNH 998 hectopascals.  
...
On initial contact, Erbil **TWR** will pass the instructions for joining the circuit, as well as any other pertinent information such as traﬃc information with the sector.

!!! phraseology
    **YYC**: Basra Tower, YYC is requesting to enter the Basra CTR from the North for circuits.     
    **BSR TWR**: YYC, Basra Tower, information A, cleared to enter the Basra CTR, maintain at or below altitude 3000ft, report left downwind runway 32 with intentions, squawk 7403.  
...
!!! phraseology
    ...
    **BSR TWR**: IAW123, Sulaymaniyah Tower, report established on the ILS runway 32.  

## Standard Taxi Routes
All departing aircraft shall be assigned the most appropriate taxiway, onto taxiway T. Basra **SMC** must exercise extreme caution on taxiway T, and ensure handoffs are made to Basra **TWR** efficiently, as conflicts can easily occur between arriving and departing traffic. 
...
The Standard Assignable level from Basra **TWR** to Baghdad **TMA** is:
...
!!! phraseology
    ...
    **BSR TWR**: IAW23, after departure climb to altitude 10,000ft, fly runway heading, surface winds variable at 3 knots, runway 32 cleared for take-off.
