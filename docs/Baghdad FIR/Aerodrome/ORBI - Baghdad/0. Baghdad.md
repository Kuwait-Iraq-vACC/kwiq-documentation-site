...
All VFR aircraft wishing to remain in the circuit at Baghdad shall be issued `A030` and the following circuit directions:
...
!!! phraseology
    ...
    **BI TWR**: ABC, Baghdad Tower, cleared to operate in the circuit area not above altitude 3000ft, left hand circuits report on the downwind, surface winds 320 degrees 5 knots, cleared for take-off runway 33L.  
