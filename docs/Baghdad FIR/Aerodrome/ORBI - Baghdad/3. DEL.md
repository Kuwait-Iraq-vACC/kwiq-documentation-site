...
### 3.2.1 General
The ground is responsible for issuing clearances for departing aircraft. Pilots may be expected to report the following information on first contact:
...
!!! info   
    At Baghdad no SIDs are used, aircraft receive departure instructions in their line up/takeoff clearance, thus ground doesn't need to provide departure instructions.  
...
At Baghdad there are no RNAV standard instrument departure procedures, thus aircraft are not given any departure procedures in there initial clearance with ground.
