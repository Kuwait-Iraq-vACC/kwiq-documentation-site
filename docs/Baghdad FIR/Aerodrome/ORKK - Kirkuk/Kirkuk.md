...
| --------- | --------	| ---------	| -------- | ------- |
| **Kirkuk TWR** | **Kirkuk Tower** | **125.550** | **ORKK_TWR** | |
...
!!! phraseology
    ...
    **KIK TWR**: ABC, Kirkuk Tower, cleared to operate in the circuit area not above altitude 4000ft, left hand circuits report on the downwind, surface winds 320 degrees 5 knots, cleared for take-off runway 31.  
...
!!! phraseology
    ...
    **KIK TWR**: FYI, Kirkuk Tower, surface winds 320 degrees 5 knots, cleared for take-off runway 31.  
    **FYI**: Roger, cleared for take-off runway 31.  
    **AIRCRAFT ON THE CROSSWIND TURN**  
    **KIK TWR**: FYI, report leaving the Kirkuk CTR, maintain at or below altitude 4000ft.  
...
!!! phraseology
    ...
    **KIK TWR**: YYC, Kirkuk Tower, cleared to leave the Kirkuk CTR direct Erbil, maintain altitude 7500ft, squawk 7403, QNH 998 hectopascals.  
...
On initial contact, Kirkuk **TWR** will pass the instructions for joining the circuit, as well as any other pertinent information such as traffic information with the sector.

!!! phraseology
    **YYC**: Kirkuk Tower, YYC is requesting to enter the Kirkuk CTR from the southeast for circuits.     
    **KIK TWR**: YYC, Kirkuk Tower, information A, cleared to enter the Kirkuk CTR, maintain at or below altitude 4000ft, report final runway 31 with intentions, squawk 7403.  
    ...
    **KIK TWR**: YYC, correct, QNH 998 hectopascals.    
...
All departing aircraft will fly an omni-directional departure.
...
The Standard Assignable level from Kirkuk **TWR** to Baghdad **TMA** is:
...
All aircraft that are flying an omni-directional departure must receive an assigned heading with their line up or take-off clearance. 'Next' coordination is not required to the relevant Baghdad **TMA** controller when the departing aircraft has been assigned the standard assignable level and assigned one of the headings listed below:
...
!!! phraseology
    ...
    **KIK TWR**: IAW23, after departure climb to altitude 4000ft, fly runway heading, surface winds variable at 3 knots, runway 31 cleared for take-off.
